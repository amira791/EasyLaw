    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('etat', models.CharField(choices=[('Active', 'Active'), ('Not Active', 'Not Active')], max_length=20, null=True)),
                ('nom', models.CharField(max_length=255, null=True)),
                ('prenom', models.CharField(max_length=255, null=True)),
                ('role', models.CharField(choices=[('client', 'Client'), ('moderateur', 'Moderateur'), ('admin', 'Admin')], default='client', max_length=20)),
