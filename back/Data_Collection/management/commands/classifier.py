...
from Data_Collection.models import JuridicalText
from User.models import IntrestDomain
import pandas as pd

def get_text_clf():
    # Load the data from the CSV file
    dataset = pd.read_csv(r'C:\Users\Manel\Documents\juridical_texts_grouped.csv')
