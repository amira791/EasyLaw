        ...
        <div className="searchResult-container">
          {currentResults.map(result => (
            <div key={result.id_text} className="searchResult-item">
              ...
              <Link to={`http://127.0.0.1:8000/data_collection/details?official_journal_year=${result.official_journal_year}&official_journal_number=${result.official_journal_number}&official_journal_page=${result.official_journal_page}#page=${result.official_journal_page}`} target="_blank">التفاصيل</Link>
              <div>
